...
@section('admin_pages')
<form action="{{route('series-content.store')}}" method="POST">
    @csrf
    <div class="p-4 rounded-xl shadow-[1px_1px_10px_2px_rgba(0,0,0,0.1)]">
        ...
        <div class="mt-2">
            ...
            <div class="flex items-end justify-end gap-x-2 mt-2">
                <a href="{{route('series-content.index')}}" class="p-2 rounded bg-slate-300 text-bg-slate-800 active:bg-slate-400 active:text-white">Back</a>
